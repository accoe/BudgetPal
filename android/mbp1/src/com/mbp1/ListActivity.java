...
public class ListActivity extends BaseAdapter {
	...
	public ListActivity(Activity a, List<String> Aktywnosc, List<Double> Koszt, List<String> Data, List<String> Rodzaj) {
		this.activity = a;
		this.list_nazwa = Aktywnosc;
		this.list_koszt = Koszt;
		this.list_data = Data;
		this.list_rodzaj = Rodzaj;
		ListActivity.inflater = (LayoutInflater)activity.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(this.list_rodzaj.get(position).equals("wydatek"))
			holder.text_koszt.setText(Html.fromHtml("<font color='#D40000'><b>- "+formatter.format(this.list_koszt.get(position))+" z³</b></font>"));
		else holder.text_koszt.setText(Html.fromHtml("<font color='#55AB3D'><b>+ "+formatter.format(this.list_koszt.get(position))+" z³</b></font>"));
